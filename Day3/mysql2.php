...
<?php
    ...
    if ($row['name']=="Rohan"){
        ...
        $perce=$usum/5;
        $uid=$row['id'];
        mysqli_query($con,"UPDATE `result`.`class1` SET sub5=99,
        `total obtained`=$usum,
        percentage=$perce
        WHERE id=$uid;");
        // echo"jsnj<br><br><br>";
        $uextract=mysqli_query($con,"SELECT * FROM `result`.`class1` WHERE `name`='Rohan';");
        while($rows=mysqli_fetch_assoc($uextract)){
        echo"--------------------------------UPDATED DETAILS----------------------------------------------<br><br><br>
        <b>Name of Student*:</b>".$row['name']."<br><br>
        <b>Marks in Each Subject </b> <br><br>
        <b>Subject 1*:</b>".$rows['sub1']."/100<br><br>
        <b>Subject 2*:</b>".$rows['sub2']."/100<br><br>
        <b>Subject 3*:</b>".$rows['sub3']."/100<br><br>
        <b>Subject 4*:</b>".$rows['sub4']."/100<br><br>
        <b>Subject 5*:</b>".$rows['sub5']."/100<br><br>
        <b>Total Marks Obtained:".$rows['total obtained']."</b><br><br>
        <b>Total Marks : </b>".$rows['total marks']."<br><br>
        <b>Percentage : </b>".$rows['percentage']."<br><br><br>";
    }
